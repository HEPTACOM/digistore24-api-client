...
class CreatePaymentplan extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    ...
    {
        return str_replace(['{apiToken}'], [$this->apiToken], '/{apiToken}/json/createPaymentplan');
    }
