...
class ListProductsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Heptacom\\DigiStore24\\Model\\ListProducts';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Heptacom\\DigiStore24\\Model\\ListProducts';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Heptacom\DigiStore24\Model\ListProducts();
        ...
        if (property_exists($data, 'product_group_name')) {
            $object->setProductGroupName($data->{'product_group_name'});
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->getProductGroupName() !== null) {
            $data->{'product_group_name'} = $object->getProductGroupName();
        }
