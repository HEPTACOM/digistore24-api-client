...
class ListEticketsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Heptacom\\DigiStore24\\Model\\ListEticketsResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Heptacom\\DigiStore24\\Model\\ListEticketsResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Heptacom\DigiStore24\Model\ListEticketsResponse();
        ...
        if (property_exists($data, 'data')) {
            $object->setData($this->denormalizer->denormalize($data->{'data'}, 'Heptacom\\DigiStore24\\Model\\ListEticketsResponseData', 'json', $context));
        }
