...
class ListCurrenciesResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Heptacom\\DigiStore24\\Model\\ListCurrenciesResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Heptacom\\DigiStore24\\Model\\ListCurrenciesResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Heptacom\DigiStore24\Model\ListCurrenciesResponse();
        ...
        if (property_exists($data, 'data')) {
            ...
            foreach ($data->{'data'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Heptacom\\DigiStore24\\Model\\ListCurrencies', 'json', $context);
            }
