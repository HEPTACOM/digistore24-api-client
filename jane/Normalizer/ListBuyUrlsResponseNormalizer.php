...
class ListBuyUrlsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Heptacom\\DigiStore24\\Model\\ListBuyUrlsResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Heptacom\\DigiStore24\\Model\\ListBuyUrlsResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Heptacom\DigiStore24\Model\ListBuyUrlsResponse();
        ...
        if (property_exists($data, 'buyurls')) {
            $object->setBuyurls($this->denormalizer->denormalize($data->{'buyurls'}, 'Heptacom\\DigiStore24\\Model\\ListBuyUrlsResponseBuyurls', 'json', $context));
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if ($object->getBuyurls() !== null) {
            $data->{'buyurls'} = $this->normalizer->normalize($object->getBuyurls(), 'json', $context);
        }
