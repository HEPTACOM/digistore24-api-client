...
class ListOrderformsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Heptacom\\DigiStore24\\Model\\ListOrderformsResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Heptacom\\DigiStore24\\Model\\ListOrderformsResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Heptacom\DigiStore24\Model\ListOrderformsResponse();
        ...
        if (property_exists($data, 'data')) {
            $object->setData($this->denormalizer->denormalize($data->{'data'}, 'Heptacom\\DigiStore24\\Model\\ListOrderformsResponseData', 'json', $context));
        }
