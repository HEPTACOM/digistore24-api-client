...
class ListOrderformsResponse
{
    ...
    /**
     * @var ListOrderformsResponseData
     */
    protected $data;
    ...
    public function getData(): ListOrderformsResponseData
    {
        return $this->data;
    }

    public function setData(ListOrderformsResponseData $data): self
    {
        $this->data = $data;
